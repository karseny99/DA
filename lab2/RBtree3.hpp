...
class RBTree {
    ...
    private:
        ...
        // void check_remove_correctness(std::shared_ptr<Node> node) {
            
        //     if(node->color == RED) {
        //         node->color = BLACK;
        //     } else if(node != root) {
        //         std::shared_ptr<Node> brother = node->get_brother();

        //         if((brother->has_one_child() or brother->has_two_children()) and (brother->leftChild != nullptr and (brother->has_no_children() or brother->has_two_children()))) {
        ...
        //     }
            ...
            // while(currentParent != root and (currentNode == nullptr or currentNode->color == BLACK)) {
            ...
            //         } else {
            //             if(brother->color == BLACK and (brother != nullptr and brother->leftChild->color == RED) and (brother->rightChild == nullptr or brother->rightChild->color == BLACK)) {
        ...
        void remove_leaf(std::shared_ptr<Node> node) {
            // node is root
    ...
    public: 
        ...
        // std::shared_ptr<Node> remove_helper(std::shared_ptr<Node> node, long long value, bool& need_fix) {
        ...
        //         if(node->has_no_children() or node->has_one_child()) {

        //             std::shared_ptr<Node> successorNode;
        //             if(node->leftChild) successorNode = node->leftChild;
        //             if(node->rightChild) successorNode = node->rightChild;
        ...
        //     if(value < node->value) {
        //         node->leftChild = remove_helper(node->leftChild, value, need_fix);
        //     } else {
        //         node->rightChild = remove_helper(node->rightChild, value, need_fix);
        //     }

        //     return !need_fix ? node : check_remove_correctness(node, );
            // if(removeNode->has_no_children() or removeNode->has_one_child()) {
                
            //     if(removeNode->leftChild) successorNode = removeNode->leftChild;
            //     if(removeNode->rightChild) successorNode = removeNode->rightChild;
            ...
            // if(removeNode->has_two_children()) {
            //     successorNode = get_minimum(removeNode->rightChild);
            //     removeNode->value = successorNode->value;
            //     remove_helper(successorNode);                
            // }

            // std::cout << "===========================" << std::endl;
            // print(this);
            // std::cout << "===========================" << std::endl;
            // std::cout << "value is --->" << successorNode->parent->value << std::endl;
            // std::cout << "===========================" << std::endl;
            // if(removeNode->color == BLACK) {
            //     check_remove_correctness(successorNode->parent);
            // } 
